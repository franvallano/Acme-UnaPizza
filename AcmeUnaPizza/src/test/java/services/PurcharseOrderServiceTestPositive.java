...
public class PurcharseOrderServiceTestPositive extends AbstractTest {
	@Autowired
	...
	public void testCreatePurchaseOrder() {
		...
		purchaseOrderForm.setTotalCost(125.0);
				
		purchaseOrder = purchaseOrderService.reconstruct(purchaseOrderForm);
		purchaseOrderService.save(purchaseOrder);
		
		Assert.isTrue(totalBefore + 1 == purchaseOrderService.findAll().size());
