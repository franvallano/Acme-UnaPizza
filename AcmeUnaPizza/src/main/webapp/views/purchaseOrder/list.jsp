...
<display:table name="purchaseOrders" pagesize="10" class="displaytag" requestURI="${requestURI}" id="purchaseOrdersRow">
	...
	<security:authorize access="hasRole('ADMINISTRATOR')">
			...
			<display:column>
					<a href="purchaseOrder/administrator/details.do?purchaseOrderId=${motorbikesRow.id}">
...
<input type="button" name="new" value="<spring:message code="purchaseOrder.new" />" 
		onclick="javascript: window.location.replace('purchaseOrder/administrator/create.do');" />
